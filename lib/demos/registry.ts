...
export const DEMOS: readonly DemoMeta[] = [
  /* ---------------- demos-ai-docs ---------------- */
  {
    ...
    skills: ['Azure OpenAI / Groq vision', 'Document extraction', 'React'],
  ...
  },
  {
    ...
    skills: ['ESG reporting', 'LLM structured output', 'Zod'],
  ...
  },
  {
    ...
    skills: ['Autonomous agents', 'Claude Agent SDK concepts', 'Langfuse', 'Temporal'],
  ...
  },
  {
    ...
    skills: ['OpenAI', 'Pinecone-style retrieval', 'RAG'],
  ...
  },
  {
    ...
    skills: ['Python data pipelines', 'pandas concepts', 'Preprocessing'],
  ...
  },
  {
    ...
    skills: ['Machine learning', 'scikit-learn / TensorFlow concepts'],
  ...
  /* ---------------- demos-realtime ---------------- */
  {
    ...
    skills: ['RabbitMQ', 'IoT streaming', 'Java consumer concepts'],
  ...
  },
  {
    ...
    skills: ['BullMQ', 'Background processing', 'Workflow orchestration'],
  ...
  },
  {
    ...
    skills: ['Real-time systems', 'SSE', 'Node streaming'],
  ...
  /* ---------------- demos-backend ---------------- */
  {
    ...
    skills: ['Express / NestJS layering', 'Zod', 'REST APIs', 'Logging'],
  ...
  },
  {
    ...
    skills: ['CASL', 'RBAC', 'Audit logging', 'Enterprise backends'],
  ...
  /* ---------------- demos-product ---------------- */
  {
    ...
    skills: ['Stripe Connect', 'Subscriptions', 'Webhooks'],
  ...
  },
  {
    ...
    skills: ['webpack', 'Performance optimisation', 'React'],
  ...
  },
  {
    ...
    skills: ['React Query', 'Data fetching', 'Caching'],
  ...
  },
  {
    ...
    skills: ['Competitive programming', 'C / C++ fundamentals'],
  ...
  },
  {
    ...
    skills: ['SQL', 'PostgreSQL / MySQL', 'Drizzle concepts'],
  ...
  },
  {
    ...
    skills: ['Design systems', 'Tailwind', 'Accessibility'],
  ...
  },
  {
    ...
    skills: ['C fundamentals', 'Game logic'],
  ...
  },
  {
    ...
    skills: ['CI/CD', 'Docker', 'Vercel / AWS deployment'],
