...
export const notes: DemoNotes = {
  ...
  limits: [
    ...
    'Only the outward postcode is sent, to carbonintensity.org.uk (or through this site’s proxy to it). Nothing is estimated when the feed is down.',
  ],
